        ...
        <div class="row">
            ...
            <div class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo html_escape($this->lang->line("breadcrumb_tag")); ?>
            ...
            <div class="page-content">
                <div class="col-sm-12 col-md-8">
                    ...
                    <div class="content">
                        <h1 class="page-title"> <?php echo html_escape($this->lang->line("page_title_tag")); ?>
